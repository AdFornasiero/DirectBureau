<!-- START : HEADING -->
<div class="text-white mt-5 border border-blue-800 py-0 w-full h-full" style="background-image:url('https://demos.onepagelove.com/html/leno/images/header-background.jpg')">
  <section class="px-2 lg:px-0 mt-16 sm:mt-32 flex w-full container mx-auto pb-16">
    <div class="w-full text-white flex justify-center md:justify-start text-center md:text-left">
      <div class="md:w-1/2 w-full">
        <h2 class="leading-none font-bold text-2xl xs:text-2x1 md:text-5xl lg:6x1 uppercase">cartouche <span class="text-red-400">d'imprimante</span></h2>
        <p class="mt-12 mb-12">Vous rechercher une cartouches d'imprimante ? Livrer en tant et en heure ? Direct Bureau est la pour vous !</p>
        <input class="px-16 rounded-full bg-red-400 text-black py-3 px-4 focus:outline-none focus:bg-white" type="text" placeholder="Rechercher">
      </div>
...
<!-- START : CAROUSEL -->
<div class="mx-auto p-1 sm:p-24 lg:p-30 ">
  <!-- START : SLIDER-1 -->
    ...
    <div class="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl" style="min-height: 19rem;">
      ...
      <div class="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
        <div class="p-12 md:pr-24 md:pl-16 md:py-12">
          <p class="text-gray-600"><span class="text-gray-900">Test</span> is a UK-based fashion retailer that has nearly doubled in size since last year. They integrated Stripe to deliver seamless checkout across mobile and web for customers in 100+ countries, all while automatically combating fraud.</p>
      ...
      <button id="sButton1" onclick="sliderButton1()" class="absolute top-0 mt-32 left-0 bg-white rounded-full shadow-md h-12 w-12 text-2xl text-indigo-600 hover:text-indigo-400 focus:text-indigo-400 -ml-6 focus:outline-none focus:shadow-outline">
        <span class="block" style="transform: scale(-1);">&#x279c;</span>
      </button>
      <button id="sButton2" onclick="sliderButton2()" class="absolute top-0 mt-32 right-0 bg-white rounded-full shadow-md h-12 w-12 text-2xl text-indigo-600 hover:text-indigo-400 focus:text-indigo-400 -mr-6 focus:outline-none focus:shadow-outline">
        <span class="block" style="transform: scale(1);">&#x279c;</span>
      </button>
    </div>
  </div>
